"""user id no longer an index, need to send an id to force it to match Auth user id

Revision ID: 42db6ac9714d
Revises: 85d4e5e84ff2
Create Date: 2023-08-23 17:05:33.435517
...
revision: str = '42db6ac9714d'
down_revision: Union[str, None] = '85d4e5e84ff2'
